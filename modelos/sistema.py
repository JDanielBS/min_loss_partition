...
class Sistema:
    ...
    def __init__(self, estado_inicial, sistema_candidato, subsistema_futuro, subsistema_presente, ruta=None):
        self.__estado_inicial = estado_inicial
        self.__sistema_candidato = sistema_candidato
    ...
    def set_with_json(self, ruta):
        """
        Lee un archivo JSON y establece los atributos del objeto con los valores de las claves.
